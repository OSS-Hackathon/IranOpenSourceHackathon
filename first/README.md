...
<!-- Repos Table -->
 ...
 | [flutter-global-configs](https://github.com/initCommerce/flutter-global-configs) | A flutter package to manage application configurations via singleton pattern. | [initCommerce](https://github.com/initCommerce) | [mehdizarepour](https://github.com/mehdizarepour) | Dart | 
 ...
 | [ShamChi](https://github.com/HesamKorki/ShamChi) | Randomly selects a Persian food to cook for dinner and serves the application on a static github pages. | [HesamKorki](https://github.com/HesamKorki) | [HesamKorki](https://github.com/HesamKorki) | JavaScript, CSS, HTML | 
 ...
 | [gato](https://github.com/initCommerce/gato) | A dart utility library inspired by javascript lodash library. | [initCommerce](https://github.com/initCommerce) | [mehdizarepour](https://github.com/mehdizarepour) | Dart | 
