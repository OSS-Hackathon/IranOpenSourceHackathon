!(function (t, e, i, n) {
	...
	$(document).ready(function () {
		...
		function s() {
			$('.slider--prev, .slider--next').click(function () {
				var t = $(this),
					...
					h = $('.slider--item-right'),
					u = $('.slider--item');
				$('.slider').animate({opacity: 0.5}, 150),
					setTimeout(function () {
		...
		function cs() {
			$('.contributors-slider--prev, .contributors-slider--next').click(
				function () {
					var t = $(this),
						e = $('.contributors-slider').find(
							'.contributors-slider--item-left'
						),
						i = $('.contributors-slider').children().index(e),
						n = $('.contributors-slider').find(
							'.contributors-slider--item-center'
						),
						s = $('.contributors-slider').children().index(n),
						r = $('.contributors-slider').find(
							'.contributors-slider--item-right'
						),
						o = $('.contributors-slider').children().index(r),
						a = $('.contributors-slider').children().length,
						l = $('.contributors-slider--item-left'),
						c = $('.contributors-slider--item-center'),
						h = $('.contributors-slider--item-right'),
						u = $('.contributors-slider--item');
					$('.contributors-slider').animate({opacity: 0}, 400),
						setTimeout(function () {
							t.hasClass('slider--next')
								? a - 1 > i && a - 1 > s && a - 1 > o
									? (l
											.removeClass('contributors-slider--item-left')
											.next()
											.addClass('contributors-slider--item-left'),
									  c
											.removeClass('contributors-slider--item-center')
											.next()
											.addClass('contributors-slider--item-center'),
									  h
											.removeClass('contributors-slider--item-right')
											.next()
											.addClass('contributors-slider--item-right'))
									: i === a - 1
									? (u
											.removeClass('contributors-slider--item-left')
											.first()
						...
						$('.contributors-slider').animate({opacity: 1}, 400);
				}
			);
		}
		var o = !0,
